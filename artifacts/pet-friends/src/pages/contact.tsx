    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          <div className="inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6" style={{ background: "rgba(166,94,18,0.15)", border: "1px solid rgba(166,94,18,0.40)", color: PURPLE }}>
            Get In Touch
          </div>
      ...
      <section className="pb-24" style={{ background: BG }}>
        <div className="container mx-auto px-4">
          ...
          <div className="w-full h-[400px] rounded-2xl overflow-hidden shadow-2xl" style={{ border: "1px solid rgba(255,152,0,0.15)", boxShadow: "0 8px 48px rgba(166,94,18,0.12)" }}>
            <iframe
      ...
      {/* ── FAQ ──────────────────────────────────────────────────────────── */}
      <section className="py-24" style={{ background: BG, borderTop: "1px solid rgba(166,94,18,0.12)" }}>
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-4 mx-auto block text-center" style={{ background: "rgba(255,152,0,0.15)", border: "1px solid rgba(255,152,0,0.35)", color: ORANGE, width: "fit-content" }}>
            FAQ
          </div>
