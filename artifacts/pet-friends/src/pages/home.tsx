...
function ClientGallery() {
  ...
  return (
    <>
    <section className="py-24 relative overflow-hidden" style={{ background: BG, borderTop: "1px solid rgba(166,94,18,0.12)" }}>
      <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 50%, rgba(255,152,0,0.07) 0%, transparent 65%)" }} />
          ...
          {clientPhotos.map((photo, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(180deg, transparent 40%, rgba(17,17,17,0.55) 100%)" }}
              />
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="w-12 h-12 rounded-full flex items-center justify-center backdrop-blur-sm" style={{ background: "rgba(255,152,0,0.25)", border: "1.5px solid rgba(255,152,0,0.60)" }}>
          ...
          >
            ...
            >
              ...
              <button
                ...
                style={{ background: "rgba(255,152,0,0.25)", border: "1.5px solid rgba(255,152,0,0.50)", color: "white", backdropFilter: "blur(6px)" }}
                aria-label="Previous"
              >
...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[700px] flex items-center" style={{ background: BG }}>
        ...
        <div className="container mx-auto px-4 relative z-10 w-full py-28 lg:py-36">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }} className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold mb-6 uppercase tracking-widest" style={{ background: "rgba(255,152,0,0.15)", border: "1px solid rgba(255,152,0,0.40)", color: ORANGE, boxShadow: "0 0 16px rgba(255,152,0,0.20)" }}>
      ...
      {/* ── TRUST BAR ─────────────────────────────────────────────────────── */}
      <section style={{ background: "linear-gradient(90deg, rgba(255,152,0,0.07), rgba(166,94,18,0.07)), #111111", borderTop: "1px solid rgba(255,152,0,0.15)", borderBottom: "1px solid rgba(166,94,18,0.15)" }} className="py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            {[
              ...
              { icon: <div className="w-7 h-7 rounded mx-auto mb-2 flex items-center justify-center text-xs font-bold" style={{ background: "rgba(166,94,18,0.20)", border: `1px solid ${PURPLE}55`, color: PURPLE }}>RE</div>, label: "Part of Ragab Elhofy Group" },
            ].map((item, i) => (
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: BG }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(255,152,0,0.08) 0%, transparent 60%)" }} />
        <div className="container mx-auto px-4 relative z-10">
      ...
      {/* ── REVIEWS TEASER ────────────────────────────────────────────────── */}
      <section className="py-24 relative overflow-hidden" style={{ background: `linear-gradient(135deg, rgba(255,152,0,0.06), rgba(166,94,18,0.08)), ${BG}`, borderTop: "1px solid rgba(255,152,0,0.12)" }}>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-4" style={{ background: "rgba(255,152,0,0.15)", border: "1px solid rgba(255,152,0,0.35)", color: ORANGE }}>
              Reviews
          ...
          <div className="text-center">
            <Link href="/reviews" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold transition-all hover:brightness-125" style={{ background: "rgba(166,94,18,0.20)", border: "1px solid rgba(166,94,18,0.40)", color: "white" }}>
      ...
      {/* ── FINAL CTA ─────────────────────────────────────────────────────── */}
      <section className="py-28 text-center relative overflow-hidden" style={{ background: "radial-gradient(ellipse at 30% 50%, rgba(255,152,0,0.16) 0%, transparent 55%), radial-gradient(ellipse at 70% 50%, rgba(166,94,18,0.16) 0%, transparent 55%), #111111", borderTop: "1px solid rgba(255,152,0,0.15)" }}>
